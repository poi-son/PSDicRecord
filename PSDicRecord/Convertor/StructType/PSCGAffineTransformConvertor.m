//
//  PSCGSffineTransformConvertor.m
//  PSExtensions
//
//  Created by PoiSon on 16/1/12.
...
@interface PSCGAffineTransformConvertor()
@property(nonatomic, assign) CGAffineTransform signature;
@end

@implementation PSCGAffineTransformConvertor
- (NSString *)type{
...
- (id)getBuffer:(void *)buffer fromObject:(id)obj{
    ...
    PSAssert(NO, @"can not conver <%@ %p>:%@ to CGAffineTransform", [obj class], obj, obj);
    return nil;
}
