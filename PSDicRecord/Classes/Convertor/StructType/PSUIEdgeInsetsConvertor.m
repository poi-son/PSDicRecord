...
@interface PSUIEdgeInsetsConvertor()
@property(nonatomic, assign) UIEdgeInsets signature;
@end

@implementation PSUIEdgeInsetsConvertor
- (NSString *)type{
...
- (id)getBuffer:(void *)buffer fromObject:(id)obj{
    ...
    PSAssert(NO, @"can not conver <%@ %p>:%@ to UIEdgeInsets", [obj class], obj, obj);
    return nil;
}
