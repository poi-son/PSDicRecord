...
@interface PSUnsignedLongConvertor()
@property(nonatomic, assign) unsigned long signature;
@end

@implementation PSUnsignedLongConvertor
- (NSString *)type{
...
- (id)getBuffer:(void *)buffer fromObject:(id)obj{
    ...
    PSAssert(NO, @"can not conver <%@ %p>:%@ to unsigned long", [obj class], obj, obj);
    return nil;
}
