 ...
 *  Table Mapping
 */
@interface PSModel<M> : PSDbAttribute
...
- (BOOL)updateWithSql:(PSSql *)sq;/**< Execute update, insert or delete sql statement. */
...
- (nullable M)findFirstWithSql:(PSSql *)sql;/**< Find first model. I recomment add "limit 1" in your sql. */
