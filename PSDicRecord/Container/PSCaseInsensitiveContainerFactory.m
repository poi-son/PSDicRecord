//
//  PSCaseInsensitiveContainerFactory.m
//  PSExtensions
//
...
@implementation PSCaseInsensitiveContainerFactory
- (PSCaseInsensitiveSet<NSString *> *)createSet{
    return [PSCaseInsensitiveSet new];
}

- (PSCaseInsensitiveDictionary *)createDictionary{
    return [PSCaseInsensitiveDictionary new];
}
@end


#pragma mark - PSCaseInsensitiveDictionary
@interface PSCaseInsensitiveDictionary()
@property (nonatomic, strong) NSMutableDictionary *valuePair;
@end

@implementation PSCaseInsensitiveDictionary
...
- (BOOL)isEqual:(PSCaseInsensitiveDictionary *)object{
...
#pragma mark - PSCaseInsensitiveSet
@interface PSCaseInsensitiveSet()
@property (nonatomic, strong) NSMutableSet *values;
@end

@implementation PSCaseInsensitiveSet
- (NSMutableSet *)values{
...
- (BOOL)isEqual:(PSCaseInsensitiveSet *)object{
    if ([NSStringFromClass(self.class) isEqualToString:NSStringFromClass([object class])]) {
